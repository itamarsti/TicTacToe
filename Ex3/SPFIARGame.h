...
#define SP_FIAR_GAME_STRAIGHT_SYMBOL '|'
#define SP_FIAR_GAME_NULL_CHAR '\0'
...
/**
 * Changes the symbol of player turn in supplied game struct
 * @param src - the current game
 * @return
 * The symbol of the next player to play
 */
char changeTurn(SPFiarGame* src); //our addition!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
